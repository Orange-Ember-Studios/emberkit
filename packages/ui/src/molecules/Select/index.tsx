...
const Select: FC<SelectProps> = ({
  ...
  const [displayLabel, setDisplayLabel] = createSignal(
  ...
  const triggerCls = [
    ...
    disabled
      ? "opacity-50 cursor-not-allowed bg-surface-200"
      : "cursor-pointer hover:border-primary-500/50 hover:bg-surface-200/50",
    error
