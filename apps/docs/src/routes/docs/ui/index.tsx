      ...
      <div class="mx-auto max-w-5xl px-8 py-16 space-y-24">
        ...
        <section id="atoms">
          ...
          <div class="mb-12 ds-showcase">
            ...
            <Text size="sm" color="muted" className="mb-6">
              90+ icons from @emberkit/icons, accessible by name
            </Text>
          ...
          <div class="mb-12 ds-showcase">
            ...
            <Text size="sm" color="muted" className="mb-6">
              Semantic variants: default, success, warning, error, info, accent
            </Text>
            <div class="flex flex-wrap gap-3">
              <Badge>Default</Badge>
          ...
          <div class="mb-12 ds-showcase">
            ...
            <Text size="sm" color="muted" className="mb-6">
              With error, disabled, and different sizes
            </Text>
        ...
        <section id="molecules">
          ...
          <div class="mb-12 ds-showcase">
            ...
            <Text size="sm" color="muted" className="mb-4">
              Signals with <code class="text-primary-400">data-ek-bind</code> —
              zero-JS binding.
            </Text>
