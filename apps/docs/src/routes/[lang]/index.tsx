...
const HomePage: RouteComponent<{ params?: Record<string, string> }> = ({ params }) => {
  ...
  return (
    <div className="relative -mx-4 max-lg:-mt-6 sm:-mx-6 lg:-mx-16 lg:-mt-12 min-h-0 overflow-x-hidden text-gray-100">
      <div
        className="pointer-events-none absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[500px] w-[500px] rounded-full bg-orange-500/20 blur-[150px] motion-reduce:hidden max-md:blur-[80px]"
        aria-hidden="true"
      />
      <div
        className="pointer-events-none absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[300px] w-[300px] rounded-full bg-amber-500/15 blur-[120px] motion-reduce:hidden max-md:blur-[60px]"
        aria-hidden="true"
      />

      <section className="relative z-10 flex min-h-[85vh] flex-col items-center justify-center px-6 text-center">
        <div className="relative mb-10 h-32 w-32 shrink-0 md:h-32 md:w-32">
        ...
        <h1 className="mb-6 min-h-[1.1em] text-5xl font-bold tracking-tight md:text-7xl lg:text-8xl">
        ...
        <div className="flex min-h-[3.5rem] flex-col gap-4 sm:flex-row">
          <button
            className="inline-flex min-h-[3.5rem] min-w-[200px] items-center justify-center gap-2 rounded-full bg-gradient-to-r from-orange-500 to-orange-700 px-8 py-4 text-xl font-bold text-white shadow-lg transition-[transform,box-shadow,background] duration-300 hover:scale-[1.03] hover:from-orange-400 hover:to-orange-500 hover:shadow-[0_0_30px_rgba(249,115,22,0.4)] active:scale-95"
        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="mt-16 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
            {features.map((f) => (
              <div
                key={f.title}
                className="group rounded-2xl border border-white/5 bg-white/[0.02] p-8 transition-[border-color,background-color,transform] duration-500 hover:border-orange-500/40 hover:bg-white/[0.04] hover:-translate-y-1"
              >
                <div className="mb-5 flex h-14 w-14 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-orange-500/15 to-orange-700/10 text-orange-400 group-hover:text-orange-300">
                  {f.icon}
                </div>
      ...
      <section className="relative z-10 py-24">
        <div className="mx-auto max-w-4xl px-6">
          <div className="min-h-[20rem] overflow-hidden rounded-2xl border border-white/5 bg-[#0d1117] shadow-2xl">
            <HomeCodeDemo />
          </div>
