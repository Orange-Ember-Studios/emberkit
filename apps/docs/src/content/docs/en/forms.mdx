...
<Text color="muted" className="mb-6">EmberKit provides built-in form handling with validation, state management, and submission handling.</Text>
...
Forms work without JavaScript. The server handles the submission when JS is unavailable, then client-side validation takes over once hydrated.
</Alert>
...
- [Signals](/en/docs/signals) - Form state management
- [Routing](/en/docs/routing) - API routes for mutations
- [SSR](/en/docs/ssr) - Server-side form handling
