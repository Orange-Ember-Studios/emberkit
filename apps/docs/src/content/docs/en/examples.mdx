...
<Text color="muted" className="mb-6">Real-world examples to help you build with EmberKit.</Text>
...
Store translations as JSON and load them with `createI18nFromGlob`:
...
See [Internationalization](/en/docs/i18n) for SSR locale detection, lazy loading, and Node filesystem helpers.

## Next Steps

- [Components](/en/docs/components) - Component patterns
- [Signals](/en/docs/signals) - Reactive state
- [Context](/en/docs/context) - Sharing state
- [Internationalization](/en/docs/i18n) - JSON translations and locale routing
- [API Reference](/en/docs/api) - Complete API docs
