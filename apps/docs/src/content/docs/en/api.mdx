...
Renders a JSX element into a DOM container. Pass <code>routes</code>, <code>notFoundRoute</code>, and <code>errorRoute</code> from <code>virtual:emberkit-routes</code> for file-based client routing and default 404/500 handling.
