...
- **i18n** — JSON translation files with <code>createI18nFromGlob</code> ([guide](/en/docs/i18n))

See the full [Release 0.8.0](/en/docs/release-0-8) notes.

## Next Steps

- [Installation](/en/docs/installation) — Create a project
- [Quick Start](/en/docs/quick-start) — First routes and signals
- [Release 0.8.0](/en/docs/release-0-8) — Latest release
