...
See [Internationalization](/en/docs/i18n) for JSON catalogs, `createI18nFromGlob`, and `resolveLocaleFromRequest`.
...
See [SSR & SSG](/en/docs/ssr) for mode details.

## Next Steps

- [SSR & SSG](/en/docs/ssr) — Build pipeline and rendering modes
- [Signals](/en/docs/signals) — Reactive state
- [Head](/en/docs/head) — Declarative head tags
- [Hydration](/en/docs/hydration) — Client bindings after SSR
