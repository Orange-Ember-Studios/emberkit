...
<Text color="muted" className="mb-6">Exemples concrets pour vous aider à construire avec EmberKit.</Text>
...
Voir [Internationalisation](/fr/docs/i18n) pour la détection de locale SSR, le chargement lazy et les helpers filesystem Node.

## Prochaines étapes

- [Composants](/fr/docs/components) — Patterns de composants
- [Signals](/fr/docs/signals) — État réactif
- [Context](/fr/docs/context) — Partage d'état
- [Internationalisation](/fr/docs/i18n) — Traductions JSON et routage par locale
- [Référence API](/fr/docs/api) — Documentation API complète
