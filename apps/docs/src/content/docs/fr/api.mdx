...
Rend un élément JSX dans un conteneur DOM. Passez <code>routes</code> depuis <code>virtual:emberkit-routes</code> pour le routage client basé sur les fichiers.
