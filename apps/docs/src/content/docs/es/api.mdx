...
Renderiza un elemento JSX en un contenedor DOM. Pasa <code>routes</code> desde <code>virtual:emberkit-routes</code> para enrutamiento cliente basado en archivos.
