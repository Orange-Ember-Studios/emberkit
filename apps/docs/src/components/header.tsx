...
const Header: RouteComponent<{ locale?: DocsLocale }> = ({ locale = 'en' }) => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 flex h-16 items-center justify-between border-b border-white/5 bg-[#0b0f19]/80 px-4 shadow-[0_8px_32px_rgba(249,115,22,0.04)] backdrop-blur-xl sm:px-6">
      <div className="flex items-center gap-3">
        ...
        >
          ...
          <span className="hidden text-[1.0625rem] font-bold bg-gradient-to-r from-orange-400 via-orange-500 to-fuchsia-400 bg-clip-text text-transparent min-[420px]:inline">
            EmberKit
          </span>
        </a>
